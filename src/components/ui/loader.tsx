...
export const LoaderOne = () => {
	const transition = (x: number) => {
		return {
			...
			delay: x * 0.2,
			ease: "easeInOut" as unknown as string,
		};
	};
	return (
...
export const LoaderThree = () => {
	return (
		<motion.svg
			...
			className="h-20 w-20 stroke-muted-foreground [--fill-final:hsl(var(--warning))] [--fill-initial:hsl(var(--muted))]"
		>
...
export const LoaderFive = ({ text }: { text: string }) => {
	return (
		<div className="font-sans font-bold [--shadow-color:hsl(var(--muted-foreground))]">
