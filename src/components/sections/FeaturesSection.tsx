...
const features = [
	{
		name: "Lightning Fast",
		description: "Get instant responses with our optimized search infrastructure.",
		icon: IconBolt,
		area: "md:[grid-area:1/1/2/7] xl:[grid-area:1/1/2/5]",
	},
	{
		name: "Always Secure",
		description: "MCP authentication ensures trusted access for your AI agents.",
	...
	},
	{
		...
		description:
			"Advanced RAG hybrid technology understands context and provides accurate, relevant answers from Apple's documentation.",
		icon: IconSearch,
			...
			<div className="relative mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-4xl lg:text-center">
					...
					<p className="mt-6 text-lg leading-8 text-muted">
						Built specifically for Apple developers, our platform provides the tools and features
						you need to find answers quickly and build better apps.
					</p>
				</div>
