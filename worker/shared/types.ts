export interface Env {
	...
	STRIPE_PRICE_ID_PRO_ONETIME_WEEKLY_CNY: string;
	STRIPE_PRICE_ID_PRO_ONETIME_MONTHLY_CNY: string;
	STRIPE_PRICE_ID_PRO_ONETIME_SEMIANNUAL_CNY: string;
	STRIPE_PRICE_ID_PRO_ONETIME_ANNUAL_CNY: string;
